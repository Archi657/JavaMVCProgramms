...
public class Factura {
    ...
    String titulos[]={"Producto","Valor","Cantidad","Subtotal","IVA","Neto a pagar"};
    ...
    public DefaultTableModel adicionar(Datos objnuevo){
        factura.add(objnuevo);
        DecimalFormat formato = new DecimalFormat("#,###,###.##");
        int i;
        Object [] fila = new Object[6];
        for (i = 0; i< factura.size(); i++) {
